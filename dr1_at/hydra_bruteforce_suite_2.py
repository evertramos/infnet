...
def prepare_wordlist(items: list[str], label: str, outdir: str) -> str:
...
def get_wordlist(custom: Optional[str], defaults: list[str],
                 label: str, outdir: str,
                 use_seclists: bool = True,
                 seclists_candidates: Optional[list[str]] = None) -> str:
    """
